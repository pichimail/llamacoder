    ...
    <main className="min-h-dvh overflow-x-clip bg-[#070806] text-stone-100">
      ...
      <section className="relative isolate min-h-[calc(100dvh-4rem)] overflow-hidden px-5 py-16 sm:px-6 lg:px-8">
        <motion.div style={{ y }} aria-hidden="true" className="pointer-events-none absolute inset-0 -z-10">
          {/* Multi-layered aurora blobs — emerald/teal/lime/amber family (no
              blue-violet AI slop), each drifting slowly and independently.
              Sized responsively and clipped by the section's overflow-hidden. */}
          <div className="animate-gradient-1 absolute left-1/2 top-[-15%] h-[420px] w-[420px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(52,211,153,0.35)_0%,transparent_70%)] blur-[90px] sm:h-[560px] sm:w-[560px] md:h-[680px] md:w-[680px]" />
          <div className="animate-gradient-2 absolute right-[4%] top-[6%] h-[320px] w-[320px] rounded-full bg-[radial-gradient(circle,rgba(45,212,191,0.3)_0%,transparent_70%)] blur-[90px] sm:h-[420px] sm:w-[420px] md:h-[500px] md:w-[500px]" />
          <div className="animate-gradient-3 absolute left-[2%] top-[22%] h-[280px] w-[280px] rounded-full bg-[radial-gradient(circle,rgba(190,242,100,0.24)_0%,transparent_70%)] blur-[80px] sm:h-[360px] sm:w-[360px] md:h-[420px] md:w-[420px]" />
          <div className="animate-gradient-4 absolute left-1/2 top-[10%] h-[260px] w-[260px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(251,191,36,0.2)_0%,transparent_70%)] blur-[100px] sm:h-[340px] sm:w-[340px] md:h-[400px] md:w-[400px]" />
