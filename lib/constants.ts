...
export const MODEL_ALIASES: Record<string, string> = {
  ...
  "qwen/qwen3-coder-plus": "openrouter/qwen/qwen3-coder-plus",
  "qwen/qwen3-coder-flash": "openrouter/qwen/qwen3-coder-flash",
...
export const MODELS: ModelConfig[] = [
  ...
  },
  {
    ...
    value: "openrouter/openrouter/pareto-code",
    nativeModel: "openrouter/pareto-code",
    provider: "openrouter",
    status: "experimental",
    recommended: true,
    description: "OpenRouter code-specialized route for complex builds",
  },
  {
  ...
  },
  {
    ...
    nativeModel: "anthropic/claude-sonnet-4.6",
    provider: "openrouter",
    status: "experimental",
  ...
  },
  {
    ...
    nativeModel: "anthropic/claude-opus-4.8",
    provider: "openrouter",
    status: "experimental",
  ...
  },
  {
    ...
    value: "openrouter/anthropic/claude-opus-4.8-fast",
    nativeModel: "anthropic/claude-opus-4.8-fast",
    provider: "openrouter",
    status: "experimental",
  ...
  },
  {
    ...
    nativeModel: "deepseek/deepseek-v4-flash",
    provider: "openrouter",
    status: "experimental",
    description: "Fast OpenRouter coding model",
  },
  {
    label: "DeepSeek V3.2",
  ...
  },
  {
    ...
    nativeModel: "qwen/qwen3-coder-plus",
    provider: "openrouter",
    status: "experimental",
    recommended: true,
  ...
  },
  {
    ...
    nativeModel: "qwen/qwen3-coder-flash",
    provider: "openrouter",
    status: "experimental",
    description: "Fast OpenRouter coder route",
  },
  {
    label: "Qwen 3 Coder Free",
    value: "openrouter/qwen/qwen3-coder:free",
    nativeModel: "qwen/qwen3-coder:free",
    provider: "openrouter",
    status: "fallback",
    description: "Free Qwen coder route when available",
    maxOutputTokens: 8192,
  },
  {
    label: "Qwen 3.7 Max",
    value: "openrouter/qwen/qwen3.7-max",
    nativeModel: "qwen/qwen3.7-max",
    provider: "openrouter",
    status: "experimental",
    description: "High-capability OpenRouter Qwen model",
  },
  {
    label: "Qwen 3.7 Plus",
    value: "openrouter/qwen/qwen3.7-plus",
    nativeModel: "qwen/qwen3.7-plus",
    provider: "openrouter",
    status: "experimental",
    description: "Versatile OpenRouter Qwen model",
  },
  {
    label: "Qwen 3 Max Thinking",
    value: "openrouter/qwen/qwen3-max-thinking",
    nativeModel: "qwen/qwen3-max-thinking",
    provider: "openrouter",
    status: "experimental",
    description: "Reasoning-heavy OpenRouter Qwen model",
  },
  {
  ...
  },
  {
    ...
    nativeModel: "moonshotai/kimi-k2-thinking",
    provider: "openrouter",
    status: "experimental",
    description: "Reasoning route for deeper product architecture",
  },
  {
    label: "Kimi K2.6",
    value: "openrouter/moonshotai/kimi-k2.6",
    nativeModel: "moonshotai/kimi-k2.6",
    provider: "openrouter",
    status: "experimental",
    description: "Versatile Moonshot model via OpenRouter",
  },
  {
    label: "OpenRouter GLM 5.2",
    value: "openrouter/z-ai/glm-5.2",
    nativeModel: "z-ai/glm-5.2",
    provider: "openrouter",
    status: "experimental",
  ...
  },
  {
    ...
    nativeModel: "z-ai/glm-5.1",
    provider: "openrouter",
    status: "fallback",
    description: "Z.ai GLM fallback route via OpenRouter",
  },
  {
    label: "MiniMax M3",
