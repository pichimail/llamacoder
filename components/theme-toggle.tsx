...
function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      {theme === "system" && (
        <Monitor
          className="absolute -bottom-0.5 -right-0.5 size-2.5 opacity-50"
          strokeWidth={3}
        />
      )}
    </button>
